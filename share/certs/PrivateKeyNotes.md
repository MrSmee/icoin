...
unlocked to sign the iCoin-Qt.app bundle.
...
allowing somebody to distribute a iCoin-Qt.app or icoin-qt-setup.exe with a valid
...
that the icoin-qt.exe file inside the installer had not been tampered with.
