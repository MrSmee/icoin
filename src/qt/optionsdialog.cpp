    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new iCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->icoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting iCoin."), QMessageBox::Ok);
