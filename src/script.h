...
#ifndef H_ICOIN_SCRIPT
#define H_ICOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CiCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, iCoin always counted CHECKMULTISIGs
